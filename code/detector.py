...
def extract_sift(fn, extractor, detector):
  """
  :param fn:
  :param extractor:提取sift特征
  :param detector:提取sift特征的位置
  :return:提取到的sift特征的描述子
  """
  im = cv2.imread(fn,0)
...
def car_detector():
  ...
  bow_kmeans_trainer = cv2.BOWKMeansTrainer(12)#BOW的簇数为12
  ...
  vocabulary = bow_kmeans_trainer.cluster() #得到视觉单词12个向量(聚类中心)
